...
* License: You must have a valid license purchased in order to
* legally use the theme for your project.
...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ asset('sneat/css/custom.css') }}?v=1.1">
